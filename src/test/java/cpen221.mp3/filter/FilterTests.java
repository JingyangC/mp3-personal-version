...
public class FilterTests{
    ...
    public void testFilterTimeStampSingleEvent() {
        ...
        Event event2 = new ActuatorEvent(0.33080, 0,
                97,"Switch", false);
        Filter timeStampFilter = new Filter("timestamp", 0.0, DoubleOperator.GREATER_THAN);
    ...
    public void testFilterBooleanValueSingleEvent() {
        ...
        Event event2 = new ActuatorEvent(0.33080, 0,
                97,"Switch", true);
        Filter booleanFilter = new Filter(true, BooleanOperator.EQUALS);
    ...
    public void testBooleanFilter() {
        ...
        Filter sensorFilter = new Filter( false, EQUALS);
    ...
    public void testDoubleFilterTS() {
        ...
        Filter sensorFilter = new Filter("timestamp", 1, LESS_THAN);
    ...
    public void testDoubleFilterValue() {
        Event sensorEvent = eventList.get(0);
        Filter sensorFilter = new Filter("value", 23, GREATER_THAN_OR_EQUALS);
    ...
    public void testComplexFilter() {
        ...
        Filter sensorValueFilter = new Filter("value", 23, GREATER_THAN_OR_EQUALS);
        Filter sensorTSFilter = new Filter("timestamp", 1, LESS_THAN);
